            ...
            <div class="col-lg-15">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input name="harga" class="form-control" placeholder="Harga Barang" value="<?= $produk->harga ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="deskripsi" class="form-control" placeholder="Deskripsi Produk" cols="20" rows="6"><?= $produk->deskripsi ?></textarea>
                    </div>
